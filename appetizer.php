...
<table class="w3-table w3-bordered w3-card-4 center" style="width:70%">
  ...
  <tr style="background-color:#B0B0B0">
    ...
    <th style="padding-left:40px" width="20%"><b>Appetizer Type</th>
    <th width="10%"></th>
  </tr>
  </thead>
<?php foreach ($list_of_recipes as $recipe_info): ?> <!-- Call each row as recipe_info -->
  <tr class="recipe"> 
    ...
    <td style="padding-left:40px"><?php echo $recipe_info['appetizerType']; ?></td>
    <td style="padding-left:20px;">
      <form action="appetizer.php" method="post">
