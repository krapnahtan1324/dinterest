...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (!empty($_POST['btnAction']) && $_POST['btnAction'] == 'Rate') {
    if (!isset($_SESSION['name'])) {
      ...
      addRating($_POST['recipe_id'], $_SESSION['user'], $_POST['Rate']);
    }
        ...
        <tr class="recipe">
          ...
          <td>
            ...
            <form action="add-recipe.php" method="post">
              <input type="submit" value="Rate" name="btnAction" class="btn btn-primary" title="Click to rate this recipe 1-5" />
