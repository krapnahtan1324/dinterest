...
$username = 'root';
$password = 'Dinterestproject1234';
$host = '35.236.223.136';       // e.g., 'cs4750:us-east4:db-demo'; 
$dbname = 'dinterest';           // e.g.,'guestbook';
$dsn = "mysql:host=35.236.223.136;dbname=dinterest";   
