...
<body>
  ...
  <div class="container">
    ...
    <form name="mainForm" method="post">
      <!-- form tag tells the boundaries of where the form starts and ends -->
...
method: Allows yout to specify how the form data should be packaged
    Most commonly used are post and get 
      ...
      <div class="row mb-3 mx-3">
        Recipe ID:
        <input type="text" class="form-control" name="recipe_id" required value="<?php if (
                                                                                    $recipe_to_update
                                                                                    != null
                                                                                  ) echo $recipe_to_update['recipe_id'] ?>" />
      </div>
      ...
      <div class="row mb-3 mx-3">
        ...
        Recipe name:
        <!-- label on the screen -->
        <input type="text" class="form-control" name="recipe_name" required value="<?php if (
                                                                                      $recipe_to_update
                                                                                      != null
                                                                                    ) echo $recipe_to_update['recipe_name'] ?>" />
        <!-- 
...
-->
      ...
      <div class="row mb-3 mx-3">
        Ingredients:
        <input type="text" class="form-control" name="ingredients" required value="<?php if (
                                                                                      $recipeingredients_to_update
                                                                                      != null
                                                                                    ) echo $recipeingredients_to_update['ingredients'] ?>" />
      </div>

      <div class="row mb-3 mx-3">
        Instructions:
        <input type="text" class="form-control" name="instructions" required value="<?php if (
                                                                                      $recipe_to_update
                                                                                      != null
                                                                                    ) echo $recipe_to_update['instructions'] ?>" />
      </div>

      <div class="row mb-3 mx-3">
        Cuisine:
        <input type="text" class="form-control" name="cuisine" required value="<?php if (
                                                                                  $recipe_to_update
                                                                                  != null
                                                                                ) echo $recipe_to_update['cuisine'] ?>" />
      </div>

      <div class="row mb-3 mx-3">
        Servings:
        <input type="text" class="form-control" name="servings" required value="<?php if (
                                                                                  $recipe_to_update
                                                                                  != null
                                                                                ) echo $recipe_to_update['servings'] ?>" />
      </div>

      <div class="row mb-3 mx-3">
        Total time:
        <input type="text" class="form-control" name="total_time" required value="<?php if (
                                                                                    $recipe_to_update
                                                                                    != null
                                                                                  ) echo $recipe_to_update['total_time'] ?>" />
      </div>
      ...
      <div class="row mb-3 mx-3">
        Type of Recipe:
        <input type="text" class="form-control" name="recipeType" required value="<?php if (
                                                                                    $recipe_to_update
                                                                                    != null
                                                                                  ) echo $recipe_to_update['recipeType'] ?>" />
      </div>
      ...
      <div>
        <input type="submit" value="Add" name="btnAction" class="btn btn-dark" title="Insert a recipe into a recipe table" />
    ...
    title: Allows you to pass in some string to be used as a hint - can be used for accessibility -->
        <input type="submit" value="Confirm update" name="btnAction" class="btn btn-primary" title="Update this recipe" /> <!-- Create a submit button -->
      </div>
          ...
          if (count($results) > 0) {
            ...
            foreach ($results as $recipe_info) { ?>
              <tr>
                ...
                <td><?php echo $recipe_info['recipe_name']; ?>
                  <form action="recipe-info.php" method="post">
                    <input type="submit" value="View" name="btnAction" class="btn btn-primary" title="Click to view this recipe" /> 
                    <input type="hidden" name="recipe_id" value="<?php echo $recipe_info['recipe_id']; ?>" />
                    <input type="hidden" name="recipe_name" value="<?php echo $recipe_info['recipe_name']; ?>" />
                    <input type="hidden" name="recipe_instructions" value="<?php echo $recipe_info['instructions']; ?>" />
                  </form>
                </td>
