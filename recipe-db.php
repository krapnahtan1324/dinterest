<?php
function addRecipe($name, $instructions) // Need to pass this in the right order (depends on POST in simpleform.php) 
{
    ...
    $query = "INSERT INTO friends VALUES (:name, :instructions)"; // Minimizes the chance of being attacked 
